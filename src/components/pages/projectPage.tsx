    ...
    return (
        <section>
            <div className="w-full ">
                <div className=' bg-no-repeat bg-custom-light bg-light-gradient bg-custom-light dark:bg-dark-gradient dark:bg-custom-light  '>
                    ...
                    <div>
                        <div className=' w-full border dark:border-[#344054] border-[#D0D5DD] dark:bg-[#04080f] bg-white h-full max-h-full md:h-[156px]   flex justify-center items-center'>
                            <Container>
