    ...
    return (
        <div>
            <div className="w-full ">
                <div className=' bg-no-repeat bg-custom-light bg-light-gradient bg-custom-light dark:bg-dark-gradient dark:bg-custom-light  px-4 '>
                    <Container className="py-0">
                        <div className='flex justify-center items-center  '>
                            <div className="w-[950px] mt-[157px] flex flex-col items-center justify-center" >
                                <div className="bg-tag-light dark:bg-tag-dark dark:border-tag-dark border-tag-light border w-[240px] h-[26px] rounded-[40px]  flex justify-center items-center">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-8">
                                    {currentItems.map((hackathon: Hackathon, index: number) => (
                                        <Card
                                            ...
                                            className="group hover:shadow-card dark:hover:shadow-cardDark border-[#EAECF0] dark:border-[#344054] hover:card-border border hover:border-[#143CFD]"
                                        >
                                            <div
                                            ...
                                            <div >
                                                <div className="px-4">
                                                    <div className="flex justify-between mt-4">
                                                        ...
                                                        <div>
                                                            <div className="flex items-center gap-[6px] dark:bg-[#1D2023] bg-[#F9FAFB] py-[2px] px-4 rounded-[4px]">
