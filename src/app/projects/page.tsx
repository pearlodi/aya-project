...
import filter from '../../../public/images/filter-lines.svg'
            ...
            <div className='w-full flex justify-center items-center pt-11 px-4 lg:px-0 dark:bg-[#04080f]'>
                <div className='w-full max-w-full md:w-[1195px]'>
                    ...
                    <div className='mt-[50px] flex items-center justify-between'>
                        ...
                        />
                        <div className='border dark:border-[#344054] border-[#98A2B3] py-3 px-[18px] gap-[10px] rounded-[8px] font-semibold text-base dark:text-[#667085] text-[#344054] flex items-center'><Image src={filter} alt='filter'/> Filter</div>
                    </div>
                </div>
