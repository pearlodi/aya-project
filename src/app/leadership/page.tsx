...
import hackathon from '../../../public/images/hackathon.svg'
                        ...
                        {!loading && currentItems.length > 0 ? (
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-8">
                                {currentItems.map((hackathon: Hackathon, index: number) => (
                                    <Card
                                    key={index}
                                    className={`border dark:border-[#344054] ${
                                      index === 1 ? 'border-[#143CFD99] dark:border-[#143CFD99] shadow-[#143CFD99]' : 'border-[#EAECF0]'
                                    }`}
                                    >
                                        <div
                                                ...
                                                <div className="flex justify-between mt-4">
                                                    <h2 
                                                       className={`font-medium  text-lg ${
                                                        index === 1 ? 'text-[#004EEB] dark:text-[#E8B8F6]' : 'dark:text-[#F9FAFB] text-[#1D2939]'
                                                      }`}
